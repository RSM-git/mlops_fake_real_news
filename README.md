[![Run tests](https://github.com/RSM-git/mlops_fake_real_news/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/RSM-git/mlops_fake_real_news/actions/workflows/tests.yml)
