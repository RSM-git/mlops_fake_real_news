...
class FakeNewsClassifier(LightningModule):
    def __init__(self, model: str = "albert-base-v2", num_classes: int = 2):
        super().__init__()
        self.model = AutoModelForSequenceClassification.from_pretrained(model, num_labels=num_classes)
